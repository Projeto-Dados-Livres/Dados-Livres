...
Revision ID: 4f538b02c5fc
Revises: 
Create Date: 2022-11-07 22:26:01.742324
...
def upgrade():
    ...
    sa.Column('description', sa.String(length=800), nullable=True),
    sa.Column('officialLink', sa.String(length=300), nullable=True),
    sa.Column('treatedLink', sa.String(length=300), nullable=True),
    sa.Column('timestamp', sa.DateTime(), nullable=True),
    sa.Column('user_id', sa.Integer(), nullable=True),
    ...
    with op.batch_alter_table('source', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_source_treatedLink'), ['treatedLink'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('source', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_source_treatedLink'))
